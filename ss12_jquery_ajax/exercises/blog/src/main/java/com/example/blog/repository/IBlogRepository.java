...
public interface IBlogRepository extends JpaRepository<Blog, Integer> {
    ...
    @Transactional
    @Modifying
    @Query(value = "insert into blog_jquery_ajax.blog(description,name,id_category) values (:description,:name,:id_category)", nativeQuery = true)
    ...
    Page<Blog> findBlogByName(Pageable pageable, @Param("name") String searchName);
